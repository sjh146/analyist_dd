...
- 갱신: 2026-09-25T22:40:53+09:00
- 목표: 최종 목표: 순손익(₩) — 리서처 데이터 → 엔지니어 AUC → 트레이더 돈

```
[퀀트 목표 사슬] 22:40 — 최종 목표: 돈(순손익)
...
🔬 퀀트리서처: DQ ok | 살아있는 피처 164 / 죽은 35 | 종목상수 0.329 | 뉴스신선도 0.42h
[사람 개입 필요]
...
- 리서처: `/home/jhshi/analyist_dd/data/reports/dq_snapshots/dq_*.json` (최신 dq_20260925-220013.json)
